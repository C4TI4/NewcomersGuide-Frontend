    ...
    <>
        ...
        <div className='flex flex-col gap-4 flex-wrap justify-center items-center mt-16'>
          {/* <form onSubmit={translateDocument} className='text-center w-fit border-2 border-red-600'> */}
            <input type='file' name='translateDocument' onChange={handleDocument} className="basis-full sm:basis-auto w-fit border-2 border-grey-800 rounded-lg" />
            <div className='flex gap-4'>
              <Button color="danger" className='h-fit py-2 bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 focus:outline-none' onPress={translateDocument}>
                Translate Document
              </Button>
              <Button color="danger" className='w-fit h-fit py-2 mx-auto bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 focus:outline-none' isDisabled={!!objectURL}>             
